...
def convert(svg_path: Path) -> str:
    ...
    return (
        ...
        f"assets/icons/file_icons/{svg_path.name} — do not edit. -->\n"
...
def kotlin(suffixes: dict[str, str], stems: dict[str, str], icons: dict[str, str]) -> str:
    ...
    return f'''package to.eyed.conquest.code.ui.workspace
...
def main() -> int:
    ...
    parser.add_argument("--zed", default="/home/carlo/Scrivania/insp/zed")
    ...
    out_kotlin = (
        repo / "app/src/main/java/to/eyed/conquest/code/ui/workspace/ZedFileIcons.kt"
    )
