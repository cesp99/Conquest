...
class GitCloneTest {
    ...
    fun acceptsAPlainLocalPath() {
        assertEquals("conquest", GitCloneUrl.projectName("/srv/git/conquest.git"))
        assertEquals("conquest", GitCloneUrl.projectName("conquest"))
    }
    ...
    fun readsPhasesAndPercentages() {
        ...
        assertEquals(CloneProgress("Cloning", null), GitProgress.parse("Cloning into 'conquest'..."))
    }
