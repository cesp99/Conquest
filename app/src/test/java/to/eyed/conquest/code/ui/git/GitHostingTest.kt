...
class GitHostingTest {
    ...
    fun theThreeGitSpellingsAllParse() {
        assertEquals("cesp99/conquest", githubRepoSlug("https://github.com/cesp99/conquest.git"))
        assertEquals("cesp99/conquest", githubRepoSlug("git@github.com:cesp99/conquest.git"))
        assertEquals("cesp99/conquest", githubRepoSlug("ssh://git@github.com/cesp99/conquest.git"))
    }
    ...
    fun theCommitUrlIsThePermalink() {
        assertEquals(
            "https://github.com/cesp99/conquest/commit/abc123def",
            githubCommitUrl("git@github.com:cesp99/conquest.git", "abc123def"),
        )
