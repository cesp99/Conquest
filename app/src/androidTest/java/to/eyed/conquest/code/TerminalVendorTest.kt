...
class TerminalVendorTest {
    ...
    fun escapeSequencesAreInterpretedNotPrinted() {
        ...
        val session = startShell(
            ...
            arrayOf("sh", "-c", "printf '\\033]0;conquest-title\\007\\033[1mstyled\\033[0m\\n\\007'"),
        )
        try {
            ...
            assertTrue("OSC leaked into the screen:\n$screen", !screen.contains("conquest-title"))
            ...
            assertEquals("conquest-title", client.title)
